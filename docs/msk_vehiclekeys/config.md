...
menu = {
    ...
    -- Supported Menus: nui (own UI), msk_context, msk_menu, ox_context, ox_menu
...
-- On QBCore the principals are named qbcore.<name> and the levels are god, admin
-- and mod. Both spellings are accepted since v3.3.3.
